...
begin
	...
	report "SSSSSSSAAAAAAAAAAAAUUUUUUUUUCCCCCCCCCEEEEEEEEEEEE11111111111111111111111111111111111111111111"
	severity error;

        assert(to_integer(unsigned(b)) = 4)
	report "SSSSSSSAAAAAAAAAAAAUUUUUUUUUCCCCCCCCCEEEEEEEEEEEE22222222222222222222222222222222222222222222"
	severity error;
        stop <= '1';
        wait;
    end process;
